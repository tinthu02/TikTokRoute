...
EXTRA_HASHTAGS = [
    # Cafe — đang mỏng nhất so với thực tế Đà Lạt
    "cafeviewdalat",
    "caphedalat",
    "dalatcafe",

    # Ẩm thực cụ thể — nhà hàng chỉ có 2 POI
    "anvatdalat2024",
    "banhmidalat",
    "comdalat",

    # Checkin / địa điểm — còn thiếu nhiều
    "dalat2024",
    "checkindalat",
    "khamphadalat2024",
]
...
RAW_CSV  = "dalat_videos_raw_extra2.csv"
POI_CSV  = "dalat_poi_extracted_extra2.csv"
