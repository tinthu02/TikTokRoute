...
def check_ollama():
    try:
        ...
        if not has_model:
            print("  Model chua co, dang pull: " + OLLAMA_MODEL + " ...")
            # Pull model — stream output để thấy tiến trình
            ...
            print("  Ollama OK - dang dung model: " + OLLAMA_MODEL)

    except requests.exceptions.ConnectionError:
        print("\n  OLLAMA CHUA CHAY!")
        print("  Tai Ollama tai https://ollama.com, mo app roi chay lai script.")
        raise SystemExit(1)
    except subprocess.CalledProcessError as e:
        print("  Pull that bai: " + str(e))
        raise SystemExit(1)
...
RAW_CSV  = "dalat_videos_raw.csv"
POI_CSV  = "dalat_poi_extracted.csv"
